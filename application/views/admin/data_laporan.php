                    ...
                    <div>
                        <div class="card-body">
                            <ul class="nav user-profile-nav justify-content-center justify-content-md-start nav-pills border-bottom-0 mb-0" role="tablist">
                                ...
                                <li class="nav-item mb-0">
                                    <a class="nav-link d-flex px-1" href="<?=base_url('admin/Data_laporan/feedback/')?>" role="tab" aria-selected="false"><i class="bx bxs-message-rounded-dots"></i><span class="d-none d-md-block">Feedback</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        success: function (response) {
                            if(response == 1){
                                ...
                                Swal.fire({
                                    position:	"top-center-start",
                                    icon: "error",
                                    title: "Pengaduan Tidak Dapat Dihapus",
                                    showConfirmButton: false,
                                    timer: 2000,
                                    confirmButtonClass: "btn btn-primary",
                                    buttonsStyling: false,
