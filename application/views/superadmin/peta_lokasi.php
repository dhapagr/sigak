                                    ...
                                    <form method="post" action="#" enctype="multipart/form-data">
                                        <div class="form-row">
                                            <div class="col-md-4 col-sm-12 form-group"> 
                                                ...
                                                <input type="text" class="form-control" id="longitude" name="longitude" placeholder="Longitude" value="<?= $key['longitude'] ?>" disabled />
                                            </div> 
                                            <div class="col-md-4 col-sm-12 form-group"> 
                                                <label for="validationTooltip02">Latitude</label> 
                                                <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Latitude" value="<?= $key['latitude'] ?>" disabled /> 
                                            </div> 
                                            <div class="col-md-4 col-sm-12 form-group"> 
                                                <label for="validationTooltip02">Ketinggian</label> 
                                                <input type="text" class="form-control" id="height" name="height" placeholder="Ketinggian" value="<?= $key['ketinggian'] ?>" disabled /> 
                                            </div> 
    ...
    <script>
        <?php foreach ($data_lokasi as $key) : ?>
            ...
            }).setView({ lng: INITIAL_LNG, lat: INITIAL_LAT }, HEIGHT);
